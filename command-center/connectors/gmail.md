...
Native connector tools: `mcp__claude_ai_Gmail__*`. No send, no permanent delete — replies are drafts I
approve in Gmail; deletes and reads are done with labels.
